...
emp_qvalues1 = pd.read_csv(
    f"./{app_config.SPECIAL_PATH}/{app_config.PATH_ONE}/emp_qvalues.csv")
emp_qvalues1.index = np.arange(1, len(emp_qvalues1) + 1)
emp_qvalues1.reset_index(inplace=True)

emp_steps_qvalues1 = pd.read_csv(
    f"./{app_config.SPECIAL_PATH}/{app_config.PATH_ONE}/emp_step_qvalues.csv")
...
emp_qvalues2 = pd.read_csv(
    f"./{app_config.SPECIAL_PATH}/{app_config.PATH_TWO}/emp_qvalues.csv")
emp_qvalues2.index = np.arange(1, len(emp_qvalues2) + 1)
emp_qvalues2.reset_index(inplace=True)

emp_steps_qvalues2 = pd.read_csv(
    f"./{app_config.SPECIAL_PATH}/{app_config.PATH_TWO}/emp_step_qvalues.csv")
...
def update_graph_scatter(x):
    ...
    fpath = f"./{app_config.SPECIAL_PATH}/{app_config.PATH_ONE}/phase_{app_config.step}/model_epoch_{app_config.epoch}.pt"
    ...
    fpath2 = f"./{app_config.SPECIAL_PATH}/{app_config.PATH_TWO}/phase_{app_config.step}/model_epoch_{app_config.epoch}.pt"
